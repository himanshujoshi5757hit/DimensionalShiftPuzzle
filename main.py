...
class Game:
    def __init__(self):
        ...
        self.main_menu_buttons = [
            ...
            Button(SCREEN_WIDTH//2 - 100, 270, 200, 50, "Tutorial"),
            Button(SCREEN_WIDTH//2 - 100, 340, 200, 50, "Controls"),
            Button(SCREEN_WIDTH//2 - 100, 410, 200, 50, "Quit")
        ]
        
        # Create buttons for pause menu
        self.pause_menu_buttons = [
            Button(SCREEN_WIDTH//2 - 100, 200, 200, 50, "Resume"),
            Button(SCREEN_WIDTH//2 - 100, 270, 200, 50, "Restart Level"),
            Button(SCREEN_WIDTH//2 - 100, 340, 200, 50, "Main Menu")
        ]
        
        # Create background
        try:
            bg_images = [
                "assets/images/bg_layer1.jpeg",
                "assets/images/bg_layer2.jpeg",
                "assets/images/bg_layer3.jpeg"
            ]
    ...
    def handle_events(self):
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                # Handle space key for various game states
    ...
    def draw_game(self):
        ...
        if self.background:
            ...
            try:
                ...
                bg_path = os.path.join(base_path, "assets", "images", f"background_{self.level_manager.current_level + 1}.png")
    ...
    def draw_ui(self):
        ...
        self.screen.blit(level_surf, (SCREEN_WIDTH - level_surf.get_width() - 10, 10))
...
class Game:
    def __init__(self):
        ...
        self.settings_buttons = [
            Button(SCREEN_WIDTH//2 - 150, 180, 300, 50, "Difficulty: Easy", (50, 100, 200), (100, 150, 255)),
            Button(SCREEN_WIDTH//2 - 150, 240, 300, 50, "Particles: On", (50, 150, 50), (100, 200, 100)),
            Button(SCREEN_WIDTH//2 - 150, 300, 300, 50, "Sound Effects: On", (150, 100, 50), (200, 150, 100)),
            Button(SCREEN_WIDTH//2 - 150, 360, 300, 50, "Music: On", (100, 100, 150), (150, 150, 200)),
            Button(SCREEN_WIDTH//2 - 150, 420, 300, 50, "Show FPS: Off", (150, 50, 150), (200, 100, 200)),
            Button(SCREEN_WIDTH//2 - 150, 480, 300, 50, "Back", (150, 50, 50), (200, 100, 100))
        ]
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_ESCAPE:
                    if self.game_state == GameState.PLAYING:
                        ...
                        self.game_state = GameState.PLAYING
                    elif self.game_state in [GameState.CONTROLS, GameState.SETTINGS, GameState.CREDITS]:
                        self.game_state = GameState.MAIN_MENU
                    else:
                        return False
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if self.game_state == GameState.MAIN_MENU:
                    for i, button in enumerate(self.main_menu_buttons):
                        if button.is_clicked(event):
                            self.menu_sound.play()
                            print(f"Main menu button {i} clicked: {button.text}")
                            if i == 0:  # Start Game
                                self.start_game()
                            elif i == 1:  # Customize
                                ...
                                print("Showing Controls screen")
                                # Launch the simple controls screen directly
                                import simple_controls
                                simple_controls.show_controls()
                            elif i == 4:  # Settings
                    ...
                    for i, button in enumerate(self.pause_menu_buttons):
                        if button.is_clicked(event):
                            self.menu_sound.play()
                            print(f"Pause menu button {i} clicked: {button.text}")
                            if i == 0:  # Resume
                                self.game_state = GameState.PLAYING
                            elif i == 1:  # Customize
                                self.show_customization = True
                            elif i == 2:  # Controls
                                print("Showing Controls screen from pause menu")
                                # Launch the simple controls screen directly
                                import simple_controls
                                simple_controls.show_controls()
                            elif i == 3:  # Settings
                    ...
                    for i, button in enumerate(self.settings_buttons):
                        if button.is_clicked(event):
                            self.menu_sound.play()
                            print(f"Settings button {i} clicked: {button.text}")
                            if i == 0:  # Difficulty
                    ...
                    for button in self.credits_buttons:
                        if button.is_clicked(event):
                            self.menu_sound.play()
                            print(f"Credits button clicked: {button.text}")
                            self.game_state = GameState.MAIN_MENU
    ...
    def draw_settings(self):
        ...
        for i, desc in enumerate(descriptions):
            ...
            self.screen.blit(desc_surf, (SCREEN_WIDTH//2 - desc_surf.get_width()//2, y_pos + 30))
